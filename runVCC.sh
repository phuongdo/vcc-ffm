...
converters/parallelizer-b.py -s $nr_thread converters/pre-b.py $path/tr.csv run.py tr.ffm
converters/parallelizer-b.py -s $nr_thread converters/pre-b.py $path/te.csv run.py te.ffm
./ffm-train -k 4 -t 18 -s $nr_thread -p te.ffm tr.ffm model
